...
@Component({
  selector: 'app-epworth',
  templateUrl: './epworth.page.html',
  styleUrls: ['./epworth.page.scss'],
})
export class EpworthPage implements OnInit {
  val1: number = 0;
  val2: number = 0;
  val3: number = 0;
  val4: number = 0;
  ...
  async submit(){
    ...
    await this.backendService.sendAnswers("Epworth", answers).then(() => {
